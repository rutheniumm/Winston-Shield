...
void Shader::SetMatrix3f(const std::string& name, const glm::mat3& val) {
...
void Shader::SetVec3f(const std::string& name, const glm::vec3& val, const int numbers) {
	glUniform3fv(GetUniformLocation(name), numbers || 1, &val[0]);
}
